...
st.caption("基于无创临床指标和问卷条目的个体化 PCOS 风险评估工具。")
...
with st.container():
    ...
    with col_left:
        age = st.number_input(
            ...
            min_value=10,
            max_value=60,
            value=int(FEATURE_META["Age"]["default"]),
            step=1,
            key="Age_input"
        )
    ...
    with col_left:
        ...
        sbp = st.number_input(
            ...
            min_value=70,
            max_value=250,
            value=int(FEATURE_META["Systolic blood pressure"]["default"]),
            step=1,
    ...
    with col_right:
        ...
        dbp = st.number_input(
            ...
            min_value=40,
            max_value=150,
            value=int(FEATURE_META["Diastolic blood pressure"]["default"]),
            step=1,
        ...
        for i, (item, descriptions) in enumerate(HIRSUTISM_ITEMS.items()):
            ...
            with target_col:
                ...
                score = st.radio(
                    ...
                    index=0,
                    horizontal=True,
                    key=f"hirsutism_radio_v4_{item}",
